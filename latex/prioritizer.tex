...
\paragraph{GHTorrent}
\ghtorrent~\ref{Gousi13} mirrors all data exposed from the GitHub \api in
...
one.\erik{Is this still true?}

The visualizer is implemented as a static web application (Figure~\ref{fig:ui}).

\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{../figs/interface.pdf}
  \caption[The user interface]
  {The user interface. It shows an ordered list of pull requests that need attention. \erik{Please provide a screen shot with one PR expanded, also showing the feedback option}}
  \label{fig:ui}
\end{figure}
...
\begin{table}
  \begin{tabular}{lrrrrc}
    \hline
    \textbf{Algorithm} & \textbf{5\%} & \textbf{Mean} & \textbf{SD} & \textbf{95\%} & \textbf{Histogram} \\
    \hline
