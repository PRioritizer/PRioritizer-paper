...
Initially, time is split in configurable time windows (currently, 1 day). In
each time window, it calculates a list of features for all pull requests
...
following timewindow. The 3 pull requests with the highest probability to
be updated are reported as the important ones.
