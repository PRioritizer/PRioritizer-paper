...
\centering
\subfigure {
  \includegraphics[scale=0.45]{service-userfulness.pdf}
...
something to do with the reasons why a certain PR is ranked higher than others (\respnum{6,7,9,17,19,20}).
...
The given answers have a correlation of $0.4441$ with the activity of the project. \andy{What about probability and strength?}
...
The correlation between the activity and the lack of label support is $0.4443$. \andy{p value, strength? If we don't have that I would drop the correlation altogether}
